...
func parseFlags() {
	...
	flag.StringVar(&databaseConnStr, "d", "host=127.0.0.1 user=postgres password=1Qwerty dbname=urlshortenerdb port=5432 sslmode=disable", "postgresql connection string (only for postgresql)")
